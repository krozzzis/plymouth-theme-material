...
| `palette.accent` | `#b9d6bf` | Lock, password dots, Caps Lock indicator and progress fill |
...
| `progressWidth` / `progressHeight` | `320` / `4` | Borderless track dimensions; 80–432 / 1–6 px |
